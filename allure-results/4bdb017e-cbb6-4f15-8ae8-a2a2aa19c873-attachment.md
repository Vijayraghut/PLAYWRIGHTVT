...
- main:
  ...
  - navigation "Top languages":
    - link "English 7,056,000+ articles":
      - /url: //en.wikipedia.org/
      - strong: English
      - text: 7,056,000+ articles
    - link "日本語 1,472,000+ 記事":
      - /url: //ja.wikipedia.org/
      - strong: 日本語
      - text: 1,472,000+ 記事
    - link "Русский 2 063 000+ статей":
      - /url: //ru.wikipedia.org/
      - strong: Русский
      - text: 2 063 000+ статей
    - link "Deutsch 3.051.000+ Artikel":
      - /url: //de.wikipedia.org/
      - strong: Deutsch
      - text: 3.051.000+ Artikel
    - link "Français 2 709 000+ articles":
      - /url: //fr.wikipedia.org/
      - strong: Français
      - text: 2 709 000+ articles
    - link "Español 2.061.000+ artículos":
      - /url: //es.wikipedia.org/
      - strong: Español
      - text: 2.061.000+ artículos
    - link "中文 1,500,000+ 条目 / 條目":
      - /url: //zh.wikipedia.org/
      - strong: 中文
      - text: 1,500,000+ 条目 / 條目
    - link "Italiano 1.935.000+ voci":
      - /url: //it.wikipedia.org/
      - strong: Italiano
      - text: 1.935.000+ voci
    - link "Polski 1 668 000+ haseł":
      - /url: //pl.wikipedia.org/
      - strong: Polski
      - text: 1 668 000+ haseł
    - link "Português 1.155.000+ artigos":
      - /url: //pt.wikipedia.org/
      - strong: Português
      - text: 1.155.000+ artigos
  - search:
    - group:
