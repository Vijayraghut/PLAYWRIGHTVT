...
const jobtitles = ["SDET I","Automation Engineer","QA lead"]

// jobtitles.forEach(element => {        // istead of this we can use for of loop also
...
for(let element of jobtitles){
  ...
  await page.locator('(//input[@class="oxd-input oxd-input--active"])[2]').fill(element.Jobtitle+randomchars)
